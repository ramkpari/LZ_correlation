...
expName = 'new_STLI_practise_noise'  # from the Builder filename that created this script
...
block_one = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('stim_practise_data_block_3.csv'),
