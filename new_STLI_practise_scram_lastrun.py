...
expName = 'new_STLI_practise_scram'  # from the Builder filename that created this script
...
block_one = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('stim_practise_data_block_2.csv'),
